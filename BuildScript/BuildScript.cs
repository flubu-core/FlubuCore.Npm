   ...
   public class BuildScript : DefaultBuildScript
    {
        protected override void ConfigureBuildProperties(IBuildPropertiesContext context)
        {
            ...
            context.Properties.Set(BuildProps.ProductId, "FlubuCore.Npm");
            context.Properties.Set(BuildProps.ProductName, "FlubuCore.Npm");
            context.Properties.Set(BuildProps.BuildDir, "output");
            context.Properties.Set(BuildProps.SolutionFileName, "FlubuCore.Npm.sln");
        ...
        protected override void ConfigureTargets(ITaskContext context)
        {
            ...
            var compile = context.CreateTarget("Compile")
                ...
                .AddCoreTask(x => x.UpdateNetCoreVersionTask("FlubuCore.Npm/FlubuCore.Npm.csproj"))
        ...
        private static void PublishNuGetPackage(ITaskContext context)
        {
            ...
            context.CoreTasks().NugetPush($"output\\FlubuCore.Npm.{nugetVersion}.nupkg")
